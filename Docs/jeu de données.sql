...
(4, 'jdupont@classeo.fr', '$2a$10$COaeIJBJz1ztOSbaGkM8J.tUx0gAtlSihMHymlINDyp6e7XpbGuFS', 'ROLE_ENSEIGNANT'), --saut de id pour etre compatible avec le user dartstart
(5, 'mcurie@classeo.fr', '$2a$10$COaeIJBJz1ztOSbaGkM8J.tUx0gAtlSihMHymlINDyp6e7XpbGuFS', 'ROLE_ENSEIGNANT'),
(6, 'alice.martin@student.fr', '$2a$10$COaeIJBJz1ztOSbaGkM8J.tUx0gAtlSihMHymlINDyp6e7XpbGuFS', 'ROLE_ELEVE'),
(7, 'bob.legrand@student.fr', '$2a$10$COaeIJBJz1ztOSbaGkM8J.tUx0gAtlSihMHymlINDyp6e7XpbGuFS', 'ROLE_ELEVE'),
(8, 'chloe.dubois@student.fr', '$2a$10$COaeIJBJz1ztOSbaGkM8J.tUx0gAtlSihMHymlINDyp6e7XpbGuFS', 'ROLE_ELEVE');
...
(1, 3, 16.50), -- Alice Martin - Java / Spring Boot
(2, 3, 14.00), -- Alice Martin - BDD SQL
(3, 3, 18.00), -- Alice Martin - Angular Advanced
(1, 4, 12.00), -- Bob Legrand - Java / Spring Boot
(2, 4, 15.50), -- Bob Legrand - BDD SQL
(2, 5, 13.00); -- Chloé Dubois - BDD SQL