...
@Component({
  selector: 'app-enseignant-calendrier',
  standalone: true,
  imports: [],
  templateUrl: './calendrier.html',
  styleUrl: './calendrier.css'
})
export class EnseignantCalendrier {
  ...
  private chargerSeances(): void {
    ...
    this.emploiDuTempsService
      .getEmploiDuTempsEnseignant(user.id)
      .subscribe(seances => {

        console.log(
          'Séances enseignant reçues :',
          seances
        );
